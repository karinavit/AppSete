...
namespace AppSete.Controllers
{
    public class AcessoTipoUsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeFuncao,IdTipoUsuario")] AcessoTipoUsuario acessoTipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeFuncao,IdTipoUsuario")] AcessoTipoUsuario acessoTipoUsuario)
        {
